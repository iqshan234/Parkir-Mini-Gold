			...
			<form action="" id="manage-vehicle"> 
				...
				<div class="col-lg-12">
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Kategory Kendaraan</label>
					...
					<div class="row form-group">
						...
						<div class="col-md-5">
							<label for="" class="control-label">Plat Nomor Kendaraan</label>
					...
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Nama Pemilik Kendaraan</label>
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-sm btn-primary btn-block col-sm-3 float-right">Simpan</button>
						</div>
					</div>
				</div>
			</form>
