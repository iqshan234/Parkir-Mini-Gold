	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				...
				<h4><b>Nomor Kode Parkir : <?php echo $ref_no ?></b> </h4>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<?php if($status == 1): ?>
							<button type="button" id="checkout_btn" class="btn-sm btn btn-block col-sm-5 btn-primary"><i class="fa fa-calculator"></i> Hitung Harga Parkir Kendaraan</button>
						...
						<?php else: ?>
							<table class="table table-bordered" width="100%">
								...
								<tr>
									<th>Jam Masuk Parkir Kendaraan</th>
									<td class="text-right"><?php echo $in_timstamp ?></td>
								</tr>
								<tr>
									<th>Jam Keluar Parkir Kendaraan</th>
									<td class="text-right"><?php echo $out_timstamp ?></td>
								</tr>
								<tr>
									<th>Perbandingan Waktu Masuk Dan Keluar Parkir</th>
									<td class="text-right"><?php echo $calc ." (".(number_format($ocalc,2)).")" ?></td>
								</tr>
								<tr>
									<th>Harga Kategori Kendaraan Perjam</th>
